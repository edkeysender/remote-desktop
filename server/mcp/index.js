#!/usr/bin/env node
// Hangar MCP server — exposes one organization's fleet to an MCP client.
// Auth: an org API token (create it in the web app → MCP tab).
//   HANGAR_URL=http://<host>:<port>   HANGAR_TOKEN=hk_...
...
const server = new Server({ name: 'hangar', version: '0.1.0' }, { capabilities: { tools: {} } });
...
console.error('[hangar-mcp] ready ->', BASE);
