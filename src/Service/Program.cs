...
// FTD Remote Windows Service. Runs as LocalSystem (installed with `sc create ...
...
builder.Services.AddWindowsService(o => o.ServiceName = "FtdRemoteService");
builder.Services.AddHostedService<Supervisor>();

// Also log to the Windows Event Log when running as a service.
builder.Logging.AddEventLog(o => o.SourceName = "FTD Remote Service");
