...
// Hangar Windows Service. Runs as LocalSystem (installed with `sc create ...
...
builder.Services.AddWindowsService(o => o.ServiceName = "HangarService");
builder.Services.AddHostedService<Supervisor>();

// Also log to the Windows Event Log when running as a service.
builder.Logging.AddEventLog(o => o.SourceName = "Hangar Service");
