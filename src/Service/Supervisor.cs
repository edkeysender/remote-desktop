...
/// <summary>
/// The Remotler service body. Keeps exactly one capture worker
/// (RemotlerAgent.exe --worker) alive in the ACTIVE console session, running as
...
public sealed class Supervisor : BackgroundService
{
    ...
    {
        _log.LogInformation("Remotler service starting. Worker: {Worker}", _workerExe);
